...
public class AquariumController {
    ...
    public void monitorpH() {
        if (pHControl.isBetween()) {
            System.out.println("Nothing to do, pH is between Safe MIN and Safe MAX values! ");
        } else {
            boolean Min = pHControl.checkpHMin();
            boolean Max = pHControl.checkpHMax();
            if (!Min && !Max) {
                alarm.turnOn();
            }
        }
